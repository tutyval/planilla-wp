            ...
            <div class="owl-carousel owl-carousel-carousel">
              ...
              <div class="item">
                <div class="gtco-item">
                  ...
                  <h2><a href="#">Parque nacional</h2></a>
                  <p class="role">Paris,</p>
                </div>
              </div>
      ...
      <div class="gtco-container">
        <div class="row">
          <div class="col-md-6 gtco-news">
            ...
            <p><a href="#" class="btn btn-sm btn-special">Mas noticias</a></p>
          </div>
          <!-- END News -->
          ...
          <div class="col-md-4">
            <div class="feature-left">
              ...
              <div class="copy">
                <h3>Planificación</h3>
                <p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
                <p><a href="#" class="gtco-more">Leer más</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
